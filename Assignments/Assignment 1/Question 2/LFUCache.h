...
class LFUCache{
    ...
    unordered_map<key_type, int> hashtable;
    ...
    void swap(int index1, int index2){
        ...
        key_type key1 = heap[index1].key;
        key_type key2 = heap[index2].key;
    ...
    value_type get(key_type key){
        ...
        int keyIndex = hashtable[key];
        value_type value = heap[keyIndex].value;
        heap[keyIndex].frequency++;
        heap[keyIndex].timer = ++timer;
